AUI.add(
	...
	function(A) {
		...
		var DocumentLibraryUpload = A.Component.create(
			{
				...
				(new A.EventHandle(instance._eventHandles)).detach();
					...
					_attachEventHandlers: function() {
						...
						instance._entriesContainer = entriesContainer;

						var folderId = instance.get('host').ns('folderId');
				...
				instance._eventHandles = [
					...
					_getFolderId: function(target) {
						...
						var firstPart = (dataFolder && A.Lang.toInt(dataFolder.attr('data-folder-id')));

						var secondPart = instance.get('folderId');
		...
		var DocumentLibraryUploadEntry = A.Component.create(
			{
				ATTRS: {

				},
				NAME: 'documentlibraryentry',
				prototype: {
					initializer: function() {
						var instance = this;
		...
		var DocumentLibraryUploadEntryStatus = A.Component.create(
			{
				ATTRS: {},
				NAME: 'documentlibraryentrystatus',
				prototype: {
					initializer: function() {
						var instance = this;
		...
		var DocumentLibraryUploadEntryStatusOverlay = A.Component.create(
			{
				ATTRS: {},
				NAME: 'documentlibraryentryoverlay',
				prototype: {
					initializer: function() {
						var instance = this;
		...
		var DocumentLibraryUploadEntryStatusProgressbar = A.Component.create(
			{
				ATTRS: {},
				NAME: 'documentlibraryentryprogressbar',
				prototype: {
					initializer: function() {
						var instance = this;
		...
		Liferay.DocumentLibraryUploadEntry = DocumentLibraryUploadEntry;
		Liferay.DocumentLibraryUploadEntryStatus = DocumentLibraryUploadEntryStatus;
		Liferay.DocumentLibraryUploadEntryStatusOverlay = DocumentLibraryUploadEntryStatusOverlay;
		Liferay.DocumentLibraryUploadEntryStatusProgressbar = DocumentLibraryUploadEntryStatusProgressbar;
	},
	'',
	{
		requires: ['aui-component', 'aui-data-set-deprecated', 'aui-overlay-manager-deprecated', 'aui-overlay-mask-deprecated', 'aui-progressbar', 'aui-template-deprecated', 'aui-tooltip', 'liferay-app-view-folders', 'liferay-app-view-move', 'liferay-app-view-paginator', 'liferay-app-view-select', 'liferay-storage-formatter', 'liferay-search-container', 'liferay-storage-formatter', 'liferay-upload-base']
	}
);