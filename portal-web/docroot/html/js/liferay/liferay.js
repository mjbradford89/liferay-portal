...
(function(A, Liferay) {
	...
	// I'm keeping this here for testing purposes....so we can see what it's supposed to do lol
	if (false) {
		AUI().use('array-extras', 'json', function(A) {
						...
						A.merge(
							{
								data: {
									...
									p_auth: Liferay.authToken + 'potatoes'
								},
								dataType: 'JSON'
							},
							ioConfig
