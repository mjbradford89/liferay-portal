...
public class UserPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		newUser.setPreferredEditor(RandomTestUtil.randomString());
		...
		Assert.assertEquals(existingUser.getPreferredEditor(),
			newUser.getPreferredEditor());
	}
	...
	protected User addUser() throws Exception {
		...
		user.setPreferredEditor(RandomTestUtil.randomString());
