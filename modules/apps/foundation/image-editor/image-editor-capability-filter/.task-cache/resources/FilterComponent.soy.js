define("liferay-image-editor-capability-filter@1.0.0/FilterComponent.soy", ['exports', 'metal-component/src/Component', 'metal-soy/src/Soy'], function (exports, _Component2, _Soy) {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var filters__soy3 = ['grayscale', 'polaroid', 'sepia', 'invert'];
      ie_open('div', null, null, 'id', opt_data.key);
      ie_open('ul', null, null, 'class', 'list-unstyled list-table');
      var filterList26 = filters__soy3;
      var filterListLen26 = filterList26.length;
      for (var filterIndex26 = 0; filterIndex26 < filterListLen26; filterIndex26++) {
        var filterData26 = filterList26[filterIndex26];
        ie_open('li');
        ie_open('a', null, null, 'data-onclick', 'previewFilter', 'data-filter', filterData26);
        ie_open('div', null, null, 'id', opt_data.key + filterData26, 'style', 'position: relative;');
        if (('' + opt_data.image).indexOf('data:image') != -1) {
          ie_open('img', null, null, 'alt', 'thumbnail', 'class', 'img-rounded', 'src', soy.$$filterImageDataUri(opt_data.image), 'style', 'opacity: 0.2;', 'height', '60px', 'width', '60px');
          ie_close('img');
        } else {
          ie_open('img', null, null, 'alt', 'thumbnail', 'class', 'img-rounded', 'src', opt_data.image, 'style', 'opacity: 0.2;', 'height', '60px', 'width', '60px');
          ie_close('img');
        }
        ie_void('canvas', null, null, 'width', '60', 'height', '60', 'style', 'position: absolute; top: 0; left: 0;');
        ie_close('div');
        ie_open('span');
        itext((goog.asserts.assert(filterData26 != null), filterData26));
        ie_close('span');
        ie_close('a');
        ie_close('li');
      }
    ...
    exports.render.params = ["image", "key"];
    exports.render.types = { "image": "any", "key": "any" };
