define("liferay-image-editor-capability-filter@1.0.0/FilterControls.soy", ['exports', 'metal-component/src/Component', 'metal-soy/src/Soy'], function (exports, _Component2, _Soy) {
  'use strict';
  ...
  goog.loadModule(function (exports) {
     ...
     * @suppress {checkTypes}
     */
    function __deltemplate_s30_d3e55d4f(opt_data, opt_ignored, opt_ijData) {
      opt_data = opt_data || {};
      $templateAlias1(opt_data, null, opt_ijData);
    }
    exports.__deltemplate_s30_d3e55d4f = __deltemplate_s30_d3e55d4f;
    if (goog.DEBUG) {
      __deltemplate_s30_d3e55d4f.soyTemplateName = 'ImageEditorFilterControls.__deltemplate_s30_d3e55d4f';
    }
    soy.$$registerDelegateFn(soy.$$getDelTemplateId('ImageEditor.Controls.idom'), 'filter', 0, __deltemplate_s30_d3e55d4f);
