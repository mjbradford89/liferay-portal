...
### The liferay-ui:email-notification-settings has been deprecated and replaced with liferay-frontend:email-notification-settings
- **Date:** 2015-Nov-30
- **JIRA Ticket:** LPS-60864

#### What changed?

The `liferay-ui:email-notification-settings` taglib has been deprecated and
replaced with `liferay-frontend:email-notification-settings` taglib.

#### Who is affected?

Plugins or templates that are using the `liferay-ui:email-notification-settings`
tag need to update their usage of the tag.

#### How should I update my code?

You should import the `liferay-frontend` tag library if it isn't already and
update the tag namespace from `liferay-ui:email-notification-settings` to
